/*
 * Prompt builders for the three-phase Horizon study (Status Brief Appendices B–D).
 *
...
Step 2 — After 3 to 4 exchanges, propose FIVE distinct career directions. For each, give: the career title; one sentence on why it might fit what they've told you; one sentence on what a typical path into it looks like. Make the five varied — don't give five flavors of the same thing. Span different RIASEC types and work environments. At least one option should gently stretch beyond the obvious choices an Econ/Business student defaults to.
Step 3 — Invite them to pick the ONE they're most curious to step into and experience as their future self. Make clear they can explore others later. If they named a strong preference earlier, include it among the five and let them confirm it.
